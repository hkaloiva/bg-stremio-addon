...
PROVIDER_CACHE = TTLCache(
    default_ttl=float(os.getenv("BG_SUBS_PROVIDER_CACHE_TTL", "300")),
    max_size=_env_int("BG_SUBS_PROVIDER_CACHE_MAX", None),
)
FAILURE_CACHE = TTLCache(
    default_ttl=float(os.getenv("BG_SUBS_PROVIDER_FAIL_TTL", "30")),
    max_size=_env_int("BG_SUBS_PROVIDER_FAIL_CACHE_MAX", None),
)
